  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        setValue(
          "profilePictureURL",
          fetchedProfile.profilePictureURL || defaultAvatar
        );
  ...
  return (
    <div className="mt-20 md:mt-28 p-8 min-h-[calc(100vh-80px)] bg-bg-primary text-text-primary">
      <div className="max-w-[1024px] mx-auto">
        <h1 className="text-3xl font-bold mb-6 md:mb-9 text-center">
          Editar Perfil
        </h1>
        <div className="bg-bg-secondary p-8 rounded-lg shadow-lg w-full max-w-2xl mx-auto border border-border-color">
          ...
          >
            ...
            <div className="mt-4">
              <label className="block text-text-primary text-sm font-bold mb-2 md:mb-4">
                Elige tu Avatar:
              </label>
              {/* Avatar Actual */}
              <div className="flex flex-col items-center mb-4">
                <p className="text-sm text-text-secondary mb-2 md:mb-4">
                  Avatar Actual
                </p>
                <img
                  src={selectedAvatar}
              ...
              <div className="flex justify-center mb-4 md:my-6">
                <CustomButton
                  variant="secondary"
                  type="button"
              ...
              {loadingAvatars ? (
                ...
                <div className="grid grid-cols-4 sm:grid-cols-5 gap-4">
                  ...
                  <img
                    ...
                    className={`w-full h-auto rounded-full cursor-pointer p-1 bg-gray-700 ${
