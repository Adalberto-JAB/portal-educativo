...
const AsignaturaEditPage = () => {
    ...
    useEffect(() => {
        const fetchAsignaturaAndCarreras = async () => {
            ...
            try {
                ...
                reset(asignaturaData); // Pre-fill form with fetched data
                ...
                toast.error('Error al cargar los datos de la asignatura o las carreras.');
            } finally {
                setAsignaturaLoading(false);
                setFetchingCarreras(false);
            }
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            toast.error(err.response?.data?.message || 'Error al actualizar la asignatura.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="pt-20 p-8 min-h-[calc(100vh-80px)] bg-bg-primary text-text-primary">
            <h1 className="text-3xl font-bold mb-6">Editar Asignatura</h1>
