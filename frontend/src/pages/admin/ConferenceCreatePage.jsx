...
const validationSchema = yup.object().shape({
  ...
  duration: yup.number().typeError('La duración debe ser un número').positive('La duración debe ser un número positivo').integer().required('La duración es requerida'),
  cost: yup.number().typeError('El costo debe ser un número').min(0, 'El costo no puede ser negativo').default(0),
  isFree: yup.boolean(),
...
const ConferenceCreatePage = () => {
  ...
  return (
    <div className="pt-20 p-8 min-h-screen bg-bg-primary text-text-primary">
      <h1 className="text-3xl font-bold mb-6">Crear Nuevo Congreso/Evento</h1>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <input type="checkbox" {...field} checked={field.value} className="h-5 w-5" />
                )}
              />
            </div>
            ...
            <div>
              <label className="block text-sm font-bold mb-2">Imagen de Portada (Opcional)</label>
