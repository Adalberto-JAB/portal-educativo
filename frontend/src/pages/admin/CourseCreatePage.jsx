...
const CourseCreatePage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (!user || !user.id) {
      toast.error(
        "ID de usuario no disponible. Por favor, intenta recargar la página o iniciar sesión de nuevo."
      );
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      toast.success(
        "Curso creado exitosamente. Será visible una vez aprobado por un administrador."
      );
