    ...
    <div className="pt-20 p-8 min-h-[calc(100vh-80px)] bg-bg-primary text-text-primary">
      ...
      <div className="bg-bg-secondary p-8 rounded-lg shadow-lg w-full max-w-md mx-auto border border-border-color">
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <div>
            <label className="block text-text-primary text-sm font-bold mb-2" htmlFor="role">Rol:</label>
          ...
          <div className="flex justify-end gap-4 mt-4">
            <CustomButton type="secondary" onClick={() => navigate('/admin/users')} disabled={loading}>Cancelar</CustomButton>
