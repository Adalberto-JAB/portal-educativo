...
import EditProfilePage from '../pages/EditProfilePage'; // <-- Importar la nueva página
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/profile/edit" element={<ProtectedRoute><EditProfilePage /></ProtectedRoute>} /> {/* <-- Añadir la nueva ruta */}
