...
import ForumPostCreatePage from '../pages/ForumPostCreatePage';
...
import DocumentationCreatePage from '../pages/DocumentationCreatePage';
import DocumentationEditPage from '../pages/DocumentationEditPage';

// Páginas de Lecciones (Nuevas)
